        ...
        <form>
          <div className="row g-3">
            <div className="col-12">
              ...
              <input onChange={updateName} value={name} type="text" className="form-control" id="movieName" placeholder="Movie name" required />
            ...
            <div className="col-12">
              ...
              <div className="input-group has-validation">
                ...
                <input defaultValue={slug} type="text" className="form-control" id="slug" placeholder="Slug" required />
                <div className="invalid-feedback">
                  Slug is required.
                </div>
              </div>
